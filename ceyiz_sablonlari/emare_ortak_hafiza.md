# 🧠 Emare Ekosistemi — Ortak Hafıza ({{PROJE_AD}})

> **Son Güncelleme:** {{PROJE_TARIH}}
> **Kapsam:** {{PROJE_AD}} için paylaşılan bilgi tabanı
...
6. ✅ {{PROJE_KLASOR}}_HAFIZA.md (proje hafızası)
...
| Ad | {{PROJE_AD}} |
| Klasör | `{{PROJE_KLASOR}}` |
| Kategori | {{PROJE_KATEGORI}} |
| Port | {{PROJE_PORT}} |
| Teknoloji | {{PROJE_TECH}} |
| Çeyiz Tarihi | {{PROJE_TARIH}} |

---

## 2. Emare Ekosistemi

{{PROJE_AD}}, **Emare ekosisteminin** bir parçasıdır.
