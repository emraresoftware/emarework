# {{PROJE_AD}} — Hızlı Başlangıç (Developer Guide)
...
| 6 | `{{PROJE_KLASOR}}_HAFIZA.md` | Proje geçmişi |
...
curl http://localhost:{{PROJE_PORT}}/health
```
...
- **Derviş**: EmareAPI'de `{{PROJE_KLASOR}} Dervishi` bu projeden sorumlu
