...
```python
# {{PROJE_AD}} — Yetki Tanımları
PROJE_PERMISSIONS = [
    # Temel
    '{{PROJE_KLASOR}}.view',      # Görüntüleme
    '{{PROJE_KLASOR}}.create',    # Oluşturma
    '{{PROJE_KLASOR}}.edit',      # Düzenleme
    '{{PROJE_KLASOR}}.delete',    # Silme
    '{{PROJE_KLASOR}}.manage',    # Tam yönetim
    # Admin
    '{{PROJE_KLASOR}}.admin',     # Admin panele erişim
    '{{PROJE_KLASOR}}.users',     # Kullanıcı yönetimi
    '{{PROJE_KLASOR}}.settings',  # Ayar yönetimi
]
```
...
```python
# {{PROJE_KLASOR}}/auth/rbac.py — Kopyala, uyarla, kullan.
...
PERMISSIONS = {
    'super_admin': {'*'},
    'admin': {
        '{{PROJE_KLASOR}}.view', '{{PROJE_KLASOR}}.create',
        '{{PROJE_KLASOR}}.edit', '{{PROJE_KLASOR}}.delete',
        '{{PROJE_KLASOR}}.manage', '{{PROJE_KLASOR}}.users',
        '{{PROJE_KLASOR}}.settings', '{{PROJE_KLASOR}}.admin',
    },
    'operator': {
        '{{PROJE_KLASOR}}.view', '{{PROJE_KLASOR}}.create',
        '{{PROJE_KLASOR}}.edit',
...
| Proje Admini | admin@{{PROJE_KLASOR}}.emare.dev | admin | Proje yöneticisi |
| API Servisi | api@{{PROJE_KLASOR}}.emare.dev | super_admin | Machine-to-machine |
