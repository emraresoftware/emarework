...
> **Yürürlük Tarihi:** {{PROJE_TARIH}}
> **Kapsam:** {{PROJE_AD}} projesindeki tüm yapay zekalar
...
{{PROJE_AD}} projesinde kod yazan her yapay zeka bu anayasaya uymak zorundadır.
...
4. {{PROJE_KLASOR}}_HAFIZA.md (proje hafızası)
...
1. `{{PROJE_KLASOR}}_HAFIZA.md` — Ne yapıldı, ne öğrenildi
