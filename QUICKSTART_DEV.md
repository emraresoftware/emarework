# Emare Work — Hızlı Başlangıç (Developer Guide)
...
```bash
# Repo'ya gir
cd /Users/emre/Desktop/Emare/emarework
...
| 6 | `emarework_HAFIZA.md` | Proje geçmişi |
...
- **Derviş**: EmareAPI'de `emarework Dervishi` bu projeden sorumlu
