...
```python
# Emare Work — Yetki Tanımları
PROJE_PERMISSIONS = [
    # Temel
    'emarework.view',      # Görüntüleme
    'emarework.create',    # Oluşturma
    'emarework.edit',      # Düzenleme
    'emarework.delete',    # Silme
    'emarework.manage',    # Tam yönetim
    # Admin
    'emarework.admin',     # Admin panele erişim
    'emarework.users',     # Kullanıcı yönetimi
    'emarework.settings',  # Ayar yönetimi
]
```
...
```python
# emarework/auth/rbac.py — Kopyala, uyarla, kullan.
...
PERMISSIONS = {
    'super_admin': {'*'},
    'admin': {
        'emarework.view', 'emarework.create',
        'emarework.edit', 'emarework.delete',
        'emarework.manage', 'emarework.users',
        'emarework.settings', 'emarework.admin',
    },
    'operator': {
        'emarework.view', 'emarework.create',
        'emarework.edit',
...
| Proje Admini | admin@emarework.emare.dev | admin | Proje yöneticisi |
| API Servisi | api@emarework.emare.dev | super_admin | Machine-to-machine |
